...
export function draftApplication(listing: DraftListingFacts): ApplicationDraft {
  ...
  const body = [
    `Hi,`,
    ``,
    `I'd like to apply for the apartment at ${where}. I'm ${APPLICANT.name} — I have a credit score of ${APPLICANT.creditScore}, I'm looking to move in on ${APPLICANT.moveIn}, and I have ${APPLICANT.pet}. I'm ready to move forward and can send over any documents or details you need to process my application.`,
    ``,
    `Thanks,`,
    APPLICANT.name,
  ].join("\n");
